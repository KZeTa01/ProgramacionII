...
public class PanelRegistro extends JPanel {
    ...
    /**
     * Inserta una línea en blanco en el archivo de registro para separar
     * visualmente una ejecución de la siguiente.
     */
    public void agregarSeparadorEjecucion() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "No se pudo escribir el separador en el registro: " + e.getMessage(),
                    "Error de archivo", JOptionPane.ERROR_MESSAGE);
            cerrarArchivo();
        }
    }
